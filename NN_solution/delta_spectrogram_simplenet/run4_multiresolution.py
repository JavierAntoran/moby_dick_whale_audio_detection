...
for i in range(epoch, nb_epochs):
    ...
    if i % nb_its_dev == 0:
        ...
        if auc[i] > best_auc:
            ...
            plt.savefig('results/best_ROC_multires.png')


    net.save('models/theta_last.dat')
    save_obj([cost_train, cost_dev, err_train, err_dev, best_cost], 'models/cost_250.dat')
...
with open('results/results_250.txt', 'w') as f:
    f.write(
...
plt.savefig('results/cost_250.png')
...
plt.savefig('results/err_250.png')
...
plt.savefig('results/auc_250.png')